...
class PeriodData
{
  ...
  PeriodData({DateTime FromDate, String OrgAdmins = '', String PeriodName = '', String PeriodTypeName = '', DateTime ToDate, int TrainingtermIntervalId = 0}) 
    ...
    : this(FromDate : DateTime.fromMillisecondsSinceEpoch( DateUtil.stripFromMSDateFormat(json['FromDate']), isUtc: true),
      OrgAdmins : json['OrgAdmins'], PeriodName : json['PeriodName'], PeriodTypeName: json['PeriodTypeName'],
      ToDate : DateTime.fromMillisecondsSinceEpoch( DateUtil.stripFromMSDateFormat(json['ToDate']), isUtc: true),
